...
university:
  ...
  college: "计算机科学与技术学院"
thesis:
  title: "基于结构化 Markdown 的本科论文编译系统设计"
  title_en: "Design of a Bachelor Thesis Compiler Based on Structured Markdown"
  major: "计算机科学与技术"
  degree: "工学学士"
author:
  name: "张三"
...
本文完成了 ThesisForge V1 核心编译链和端到端验收。系统在不依赖网络或 AI 服务的条件下生成可编辑 DOCX，并以结构化测试验证关键 OOXML 对象。
