...
from docforge import __version__ as _HOST_VERSION
...
def _build_reference_docx(template: ThesisTemplate, path: Path) -> list[str]:
    ...
    from docforge.renderers.docx.styles import apply_paragraph_style
    from docforge.renderers.docx.units import to_docx_length
